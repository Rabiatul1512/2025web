                ...
                <tbody>
                  ...
                  foreach ($data as $d) : ?>
                    <tr>
                      ...
                      <td><a href="deletemahasiswa.php?nim=<?= $d['nim']; ?>" onclick="return confirm('Yakin ingin hapus')" class="btn btn-danger">Delete</a> <a href="editmahasiswa.php?nim=<?= $d['nim']; ?>" class="btn btn-primary">Edit</a></td>
                    </tr>
                  <?php endforeach; ?>
